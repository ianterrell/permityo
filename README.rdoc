...
* <tt>config.constellation.authorization.mixin = :default</tt>
* <tt>config.constellation.authorization.login_required_redirection = { :controller => 'session', :action => 'new' }</tt>
